...
if ($id > 0) $upload_dir = $conf->ultimateimmo->multidir_output[$object->entity ? $object->entity : $conf->entity] . "/owner/" . dol_sanitizeFileName($object->id);
...
if ($object->id) {
	...
	$relativepathwithnofile = 'owner/' . dol_sanitizeFileName($object->id) . '/';
